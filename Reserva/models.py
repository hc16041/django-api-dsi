...
class Reserva(BaseModel):
    ...
    hora_salida = models.CharField("Hora de salida", max_length=10, default="13:00")   
    ...
    id_servicio = models.ManyToManyField(
        "ServiciosReserva")
    numero_personas = models.CharField(
        "numero de personas", max_length=2)
...
class FechaReserva(BaseModel):
    ...
    id_reserva = models.ForeignKey(
        "Reserva.reserva", on_delete=models.CASCADE)
